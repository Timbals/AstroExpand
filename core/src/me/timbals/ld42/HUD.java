...
public class HUD {
    ...
    private final String tutorialText =
            "You run your own planet. Your goal is to make the planet bigger by injecting rocks into it." +
                    "The people that live on this planet require space. You loose if you run out of space that the people can use." +
    ...
    public void render(float delta) {
        ...
        if(game.gameOver) {
            ...
            batch.draw(
                    ...
                    uiCamera.viewportWidth / 2 - 58 * scale / 2,
        ...
        batch.draw(game.assetManager.get("freespace.png", Texture.class), 8, uiCamera.viewportHeight - 7 * 3 - 8, 39f * 3, 7f * 3);
